        ...
        try {
                    ...
                    for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                        ...
                        if (isVideo) {
                            await sock.sendMessage(chatId, {
                                video: { url: mediaUrl },
                                mimetype: "video/mp4",
                                caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 *SUCCESSFUL*"
                            }, { quoted: message });
                        } else {
                            await sock.sendMessage(chatId, {
                                image: { url: mediaUrl },
                                caption: "*DONE ✅ BY SANCHO-XMD*"
                            }, { quoted: message });
                        }
                    }
                    return;
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `DOWNLOADED BY SANCHO-XMD\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 *SANCHO-BOT*";
